...
Copy [`segmentation.config.example.json`](../examples/segmentation.config.example.json)
to the workspace's ignored
...
[`segmentation-fusion.config.example.json`](../examples/segmentation-fusion.config.example.json).
Fill both publisher-verified
