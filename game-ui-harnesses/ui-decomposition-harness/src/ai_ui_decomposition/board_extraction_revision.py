...
def revise(raw_path,strategy_path,board_id,expected_sha256,policy,reason,output):
...
def main():
    ...
    report=revise(args.raw,args.strategy,args.board,args.expected_sha256,read_json(args.policy),args.reason,args.output)
    print(report['digest'])
