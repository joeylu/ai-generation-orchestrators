...
def _parent(root, path, seen=()):
    ...
    if report["schema_version"] not in {"ai_frame_animation_reference_preparation_v4", "ai_frame_animation_reference_preparation_v6", "ai_frame_animation_reference_preparation_v7", "ai_frame_animation_reference_preparation_v8", PREPARATION_VERSION}:
