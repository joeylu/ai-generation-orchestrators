...
class ReleaseMetadataTests(unittest.TestCase):
    ...
    def test_release_consumption_names_both_skill_archives(self) -> None:
        ...
        self.assertIn("character-video", text)
        self.assertIn("image-background-removal", text)
...
"""
    ...
    def _copy_skill_source(self, root: Path) -> Path:
        ...
        for name in SKILL_FILES:
            ...
            shutil.copyfile(ROOT / SKILL_ROOT / name, target)
        return skill
    ...
    def test_skill_archive_is_reproducible_and_excludes_unlisted_files(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch("release_tools.build_release_metadata.ROOT", source):
    ...
    def test_release_command_builds_skill_asset_without_touching_wheel(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            result = subprocess.run(
                [sys.executable, "-B", str(ROOT / ".github" / "release_tools" / "build_release_metadata.py"),
