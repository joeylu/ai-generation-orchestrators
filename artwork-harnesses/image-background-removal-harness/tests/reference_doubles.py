...
def foreground_double(estimator=identity_foreground):
    with patch("ai_image_background_removal.preparation.inspect_matting_runtime"), patch(
        "ai_image_background_removal.media.reference_matte.load_foreground_estimator",
