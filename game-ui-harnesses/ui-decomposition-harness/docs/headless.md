...
normalized geometry. The structural board is uniformly scaled to the interactive
board's cell resolution; accepted pairs are then padded to identical transparent
canvases required by the component runtime. Individual asset aspect ratios do not
change.
