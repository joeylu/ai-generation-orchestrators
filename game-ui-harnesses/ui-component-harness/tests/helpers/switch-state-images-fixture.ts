...
export async function switchStateImagesFixture() {
  ...
  const fixture = await fixtureLayeredZip([500, 400], [
    ...
    { id: 'switch-track-on', role: 'important_component', left: 10, top: 70, width: 180, height: 40, color: [0, 180, 250, 255] },
    { id: 'switch-thumb-on', role: 'important_component', left: 14, top: 74, width: 32, height: 32, color: [255, 60, 100, 255] },
  ...
  const binding = {
    ...
    bindings: [
      ...
      { componentId: 'apply-switch', componentType: 'Switch', parts: [{ role: 'track', layerId: 'switch-track' }, { role: 'thumb', layerId: 'switch-thumb' }], states: { switch: {
        stateImages: { version: '1.0', off: { trackLayerId: 'switch-track', thumbLayerId: 'switch-thumb' }, on: { trackLayerId: 'switch-track-on', thumbLayerId: 'switch-thumb-on' } },
